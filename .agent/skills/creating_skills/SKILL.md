...
description: Generates high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. Use when the user wants to create a new skill or asks to generate a skill.
---
...
```
ã*cascade082Zfile:///C:/Users/FDean/Antigravity/Generador_Skills/.agent/skills/creating-skills/SKILL.md